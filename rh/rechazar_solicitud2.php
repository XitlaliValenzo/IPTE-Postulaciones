            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Rechazar solicitud</h1>
                        <hr>
                        <br>
                        <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6">
        <div class="jumbotron px-5 py-5 shadow p-3 mb-5 bg-white rounded" style="background-color: #FFF">
          <h5 class="text-center">¿Realmente quieres rechazar la solicitud de <?php echo $data['nombre']?>?</h5>
          <br>
          <br>
          <form action="php_action/rechazar_solicitud2.php" method="POST">
            <input type="hidden" name="id" value="<?php echo $data['id']?>"/>
            <div class="container-fluid text-center">
              <div class="form-group row">
                <div class="col-md-6">
                  <button type="submit" name="add" class="btn btn-success btn-lg btn-block">Sí rechazar</button>
                </div>
                <div class="col-md-6">
                  <a href="postulantes_pendientes.php" class="btn btn-danger btn-lg btn-block" role="button">Cancelar</a>
                </div>
              </div>
            </div>
          </form>
