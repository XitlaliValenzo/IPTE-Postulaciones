            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Política de privacidad</h1>
                        <hr>
      <br>
      <p  class="lead text-justify">En IPTE Soluciones, nos tomamos muy en serio la privacidad y protección de tus datos personales. Esta política de privacidad explica cómo recopilamos, usamos, divulgamos y protegemos tu información personal en relación con las funciones de este portal web, la cual principalmente consiste en el proceso de postulación para el empleo. Al utilizar este portal web, aceptas los términos de esta política de privacidad.
</p>
<br>
<h4>Información que recopilamos</h4>
<p class="lead text-justify">Recopilamos información que nos proporcionas directamente al crear tu cuenta, como tu nombre, dirección de correo electrónico, número de teléfono, edad, dirección, sexo y foto de perfil. También recopilamos información como tu curríclum al momento de realizar una postulación para alguna de nuestras vacantes y en caso de ser contratado los documentos personales subidos por ti.</p>
<br>
<h4>Cómo usamos tu información</h4>
<p class="lead text-justify">Usamos tu información para analizar tu perfil profesional y ver si es el adecuado para la vacante a la cual te postulaste. También podemos utilizar tu información para comunicarnos contigo en caso de ser necesario mediante tu número de teléfono o tu dirección de correo electrónico.</p>
<br>
<h4>Divulgación de tu información</h4>
<p class="lead text-justify">No compartimos tu información personal con terceros para fines publicitarios. Podemos compartir tu información con terceros como personas encargadas del proceso de contratación dentro del área de recursos humanos y jefes de departamentos de la empresa en caso de que tu postulación pase a una segunda etapa, siendo que es la persona que requiere el personal.
</p>
<br>
<h4>Seguridad de tu información</h4>
<p class="lead text-justify">Tomamos medidas para proteger tu información personal contra el acceso no autorizado y la divulgación.
</p>
<br>
<h4>Cambios a esta política de privacidad</h4>
<p class="lead text-justify">Nos reservamos el derecho de actualizar o cambiar esta política de privacidad en cualquier momento. Cualquier cambio a esta política de privacidad será efectivo cuando se publique en nuestro sitio web. Te recomendamos que revises periódicamente esta política de privacidad para estar al tanto de los cambios.</p>
