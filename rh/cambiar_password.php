            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Cambiar contraseña</h1>
                        <hr>
                       <br>
                          <div class="container">
  <div class="row align-items-center justify-content-center">
    <div class="col-lg-6">
      <div class="jumbotron px-5 py-5 shadow p-3 mb-5 bg-white rounded" style="background-color: #FFF">
          <form action="php_action/actualizar_password.php" method="POST" enctype="multipart/form-data">
            <div class="form-group mb-4">
                  <label for="nombre">Ingresa la nueva contraseña</label>
                  <br>
                  <br>
