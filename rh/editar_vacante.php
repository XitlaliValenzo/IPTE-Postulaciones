            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Editar vacante</h1>
                        <hr>
                        <br>
                        <div class="container">
  <div class="row align-items-center justify-content-center">
     <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/actualizar_vacante.php" method="POST">
            <div class="form-group">
              <label for="puesto_vacante">Vacante</label>
              <input class="form-control" type="text" name="puesto_vacante" id="puesto_vacante" value="<?php echo $data['puesto_vacante']?>"/>
            </div>
            <div class="form-group">
                <label for="descripcion_vacante">Descripción</label>
                <textarea class="form-control" id="descripcion_vacante" name="descripcion_vacante" rows="3" value="<?php echo $data['descripcion_vacante']?>"/><?php echo str_replace('<br />', '',$data['descripcion_vacante'])?></textarea>
            </div>
            <div class="form-group">
                <label for="perfil_vacante">Perfil</label>
                <textarea class="form-control" id="perfil_vacante" name="perfil_vacante" rows="3" value="<?php echo $data['perfil_vacante']?>"/><?php echo str_replace('<br />', '',$data['perfil_vacante'])?></textarea>
            </div>
            <div class="form-group">
              <label for="sueldo_vacante">Sueldo</label>
              <input class="form-control" type="number" name="sueldo_vacante" id="sueldo_vacante" value="<?php echo $data['sueldo_vacante']?>"/>
            </div>
            <div class="form-group">
                <label for="ubicacion_vacante">Ubicación</label>
                <textarea class="form-control" id="ubicacion_vacante" name="ubicacion_vacante" rows="3" value="<?php echo $data['ubicacion_vacante']?>"/><?php echo $data['ubicacion_vacante']?></textarea>
            </div>
            <div class="form-group">
                <label for="modalidad_vacante">Modalidad del empleo</label>
                <select name="modalidad_vacante" id="modalidad_vacante" class="form-control">
                <option value="<?php echo $data['modalidad_vacante']?>"><?php echo $data['modalidad_vacante']?></option>
                <option>Empleo presencial</option>
                <option>Empleo Home Office</option>
                </select>
            </div>
            <div class="form-group">
                <label for="modalidad_entrevista">Modalidad de la entrevista</label>
                <select name="modalidad_entrevista" id="modalidad_entrevista" class="form-control">
                <option value="<?php echo $data['modalidad_entrevista']?>"><?php echo $data['modalidad_entrevista']?></option>
            ...
            <div class="form-group">
                <label for="comentarios_vacante">Comentarios extra</label>
                <textarea class="form-control" id="comentarios_vacante" name="comentarios_vacante" rows="3" value="<?php echo $data['comentarios_vacante']?>"/><?php echo str_replace('<br />', '',$data['comentarios_vacante'])?></textarea>
            </div>
            <br>
            <br>
            <input type="hidden" name="id" value="<?php echo $data['id_vacante']?>"/>
            <div class="container-fluid text-center">
              <a href="vacantes.php" class="btn btn-danger" role="button">Atrás</a>
              <button type="reset" class="btn btn-primary">Borrar</button>
              <button type="submit" name="add" class="btn btn-success">Actualizar</button>
            </div>
          </form>
        </div>
      </div>
