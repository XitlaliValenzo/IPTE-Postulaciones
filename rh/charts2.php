            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Entrevistas</h1>
                        <hr>
                        <br>
                        <br>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fa-solid fa-calendar"></i> Entrevistas</div>
...
$sql3 = "SELECT estatus_entrevista, DATE_FORMAT(fecha_entrevista, '%M-%Y') as mes_entrevista, COUNT(id_entrevista) as total_entrevistas FROM entrevistas GROUP BY estatus_entrevista,DATE_FORMAT(fecha_entrevista, '%M-%Y') ORDER BY fecha_entrevista ASC";
...
if ($query3->num_rows > 0) {
    ...
    echo "<center><p class='text-danger'>No existen entrevistas pendientes, canceladas o realizadas</center></p><br><br><br>";
}
...
var data = {
        ...
        <?php foreach($data3 as $d3):?>
            "<?php echo strftime("%B de %Y", strtotime($d3->mes_entrevista)) . ' ' .$d3->estatus_entrevista; ?>",
        <?php endforeach; ?>
        ],
        datasets: [{
            label: "Entrevistas",
