            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Calendario de entrevistas</h1>
                        <hr>
                        <div class="text-center">
  
  <img src="img/calendario.png" class="rounded mx-auto d-block" alt="tarjeta" style="width: 100px; height: 100px;"></div>
      <br>
      <br>
      <br>
                            <div id="calendar"></div>
...
$(document).ready(function() {
  ...
  $.ajax({
    url: "php_action/entrevistas_calendario.php",
    type: "GET",
    dataType: "json",
