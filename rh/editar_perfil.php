            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Editar perfil</h1>
                        <hr>
                       <br>
                          <div class="container">
          ...
          <form action="php_action/actualizar_perfil.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                        ...
                        <div class="form-outline mb-4">
                          ...
                          <input type="text" id="puesto" name="puesto" class="form-control" value="<?php echo $data['puesto']?>" required/>
                        </div>
                        <div class="form-group">
                          <label for="exampleForControlFile1">Foto de perfil</label>
                          <input type="file" class="form-control-file" id="image" name="image" accept=".jpg, .jpeg, .png" onchange="validar()"><br>
                          <?php
                          if (empty($data['image'])){
...
echo '<center><img src="data:image;base64,' . $base64 . '" width="250" height="200" class="img-fluid rounded"/></center>';
                          }
