            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <hr>
      <br>
          <p class="text-justify lead">Al utilizar este portal web para la contratación de empleados de la empresa IPTE Soluciones, aceptas los siguientes términos y condiciones:</p>
          <ul>
  <li class="text-justify lead">Postulaciones: Las postulaciones realizadas podrán ser canceladas solamente hasta antes que el reclutador asigne la entrevista, una vez asignada la entrevista, se deberá completar con el proceso de postulación.</li>
  <li class="text-justify lead">Entrevistas: La información de las entrevistas asignadas serán publicadas por el reclutador y se podrán revisar en la opción estatus y en el calendario, una vez asignada la entrevista se tendrá que confirmar la asistencia a la misma.</li>
  <li class="text-justify lead">Estatus: Deberás revisar de manera constante tu estatus dentro del portal web, ya que ahí encontrarás toda la información necesaria y el progreso dentro del proceso de tu postulación para la vacante de empleo.</li>
  <li class="text-justify lead">Currículum y documentación: El currículum al momento de realizar una postulación deberá ser subido de manera obligatoria y en formato pdf y la documentación solicitada en caso de ser contratado deberá ser subida en el tiempo establecido por el reclutador sin excepciones y en formato pdf.</li>
  <li class="text-justify lead">Limitación de responsabilidad: IPTE Soluciones no será responsable de ningún daño incidental, especial, indirecto o consecuente que surja del uso o incapacidad de utilizar este portal web.</li>
  <li class="text-justify lead">Propiedad intelectual: Todo el contenido en nuestro portal web incluyendo imágenes, texto y marcas comerciales, es propiedad de IPTE Soluciones y está protegido por las leyes de propiedad intelectual aplicables.</li>
  <li class="text-justify lead">Modificaciones de los términos: Nos reservamos el derecho de actualizar o cambiar estos términos en cualquier momento. Cualquier cambio a estos términos será efectivo cuando se publique en nuestro portal web.</li>
</ul>
