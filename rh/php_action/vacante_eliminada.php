            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Vacante eliminada</h1>
                        <hr>
                        <br>
                        <br>
                        <div class="container">
      <div class="card mb-3 shadow p-3 mb-5 bg-white rounded border-0" style="max-width: 540px; width: auto; margin: auto auto;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <div class="container-fluid text-center">
                <h3 class="card-title text-danger" style="color: #219EBC;">¡Vacante eliminada exitosamente!</h3>
                <br>
