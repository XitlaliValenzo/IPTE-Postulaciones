...
<html lang="es">
    <head>
        ...
        <title>Asignar entrevista</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Asignar entrevista</h1>
                        <hr>
                        <br>
                        <div class="container">
                        	<div class="row align-items-center justify-content-center">
    <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/asignar_entrevista2.php" method="POST">
            <div class="form-group">
            	<label for="fecha_entrevista">Fecha de la entrevista</label>
            	<input type="date" id="fecha_entrevista" name="fecha_entrevista" class="form-control" required />
            </div>
            <div class="form-group">
            	<label for="hora_entrevista">Hora de la entrevista</label>
            	<input class="form-control" type="time" name="hora_entrevista" id="hora_entrevista" required/>
             </div>
            <?php 
                ...
                <textarea class="form-control" id="ubicacion_entrevista" name="ubicacion_entrevista" rows="3" placeholder="Ingresa la ubicación donde se realizará la entrevista" required></textarea>
            </div>
              <?php 
            	} else { ?>
            		<input type="hidden" name="modalidad_entrevista" value="<?php echo $data['entrevista']?>"/>
              ...
              <input class="form-control" type="text" name="link_teams" id="link_teams" placeholder="Ingresa el link de la reunión" required/>
            </div>
            ...
            <div class="container-fluid text-center">
              <a href="postulantes_pendientes.php" class="btn btn-danger" role="button">Atrás</a>
              <button type="reset" class="btn btn-primary">Borrar</button>
              <button type="submit" name="add" class="btn btn-success">Asignar</button>
            </div>
          </form>
        </div>
      </div>
