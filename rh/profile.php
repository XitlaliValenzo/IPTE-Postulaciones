...
<html lang="es">
  ...
  $row = $result->fetch_assoc(); ?>
                        <h1 class="mt-4">Información del Perfil</h1>
                        <hr>
                       <div class="jumbotron" style="background-color: #FFF;">
    <div class="container">
      <div class="card mb-3 shadow p-3 mb-5 bg-white" style="max-width: 100%; border: none">
  <div class="row no-gutters ">
    <div class="col-md-6">
      <?php
                          if (empty($row['image'])){
                            echo "<p class='text-danger text-center'>No has subido una foto de perfil</p>
                            <img src='img/sinfoto.webp' class='img-fluid rounded'>
                            ";
...
<br>
<br>
<h5 class="lead"><b><center><?php echo $row['nombre'] ?></center></b></h5>
    </div>
    <div class="col-md-6">
      <div class="card-body">
        <p class="lead"><i class="fa-solid fa-user-gear"></i> <b>Rol:</b> <?php echo ucwords($_SESSION['ROLE']); ?></p>
        ...
        <p class="lead"><i class="fa-solid fa-briefcase"></i> <b>Puesto:</b> <?php echo $row['puesto']?></p>
    <br>
    <a href="editar_perfil.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-block"><i class="fa-solid fa-pencil"></i> Editar información de perfil</a>
    <a href="cambiar_password.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-block"><i class="fa-solid fa-lock"></i> Cambiar contraseña</a>
      </div>
    </div>
  </div>
</div>
