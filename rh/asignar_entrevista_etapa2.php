...
<html lang="es">
    ...
    <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/asignar_entrevista_etapa2.php" method="POST">
            ...
            <?php 
              ...
              <input class="form-control" type="text" name="link_teams" id="link_teams" placeholder="Ingresa el link de la reunión">
            </div>
            ...
            <div class="container-fluid text-center">
              <a href="segunda_etapa.php" class="btn btn-danger" role="button">Atrás</a>
