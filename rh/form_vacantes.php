            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Añadir vacante</h1>
                        <hr>
                       <br>
                        <div class="container">
  <div class="row align-items-center justify-content-center">
    <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/crear_vacante.php" method="POST">
            <div class="form-group">
              <label for="puesto_vacante">Vacante</label>
              <input class="form-control" type="text" name="puesto_vacante" id="puesto_vacante" placeholder="Ingresa el título de la vacante" required/>
            </div>
            <div class="form-group">
                <label for="descripcion_vacante">Descripción</label>
                <textarea class="form-control" id="descripcion_vacante" name="descripcion_vacante" rows="3" placeholder="Ingresa la descripción de la vacante" required></textarea>
            </div>
            <div class="form-group">
                <label for="perfil_vacante">Perfil</label>
                <textarea class="form-control" id="perfil_vacante" name="perfil_vacante" rows="3" placeholder="Ingresa el perfil necesario para la postulación de la vacante" required></textarea>
            </div>
            <div class="form-group">
              <label for="sueldo_vacante">Sueldo</label>
              <input class="form-control" type="number" name="sueldo_vacante" id="sueldo_vacante" placeholder="Ingresa el sueldo" required/>
            </div>
            <div class="form-group">
                <label for="ubicacion_vacante">Ubicación</label>
                <textarea class="form-control" id="ubicacion_vacante" name="ubicacion_vacante" rows="3" placeholder="Ingresa la ubicación de la vacante" required></textarea>
            </div>
            <div class="form-group">
                <label for="modalidad_vacante">Modalidad del empleo</label>
                <select name="modalidad_vacante" id="modalidad_vacante" class="form-control" required/>
                <option selected disabled value="">Seleccionar ...</option>
                <option>Empleo presencial</option>
                <option>Empleo Home Office</option>
                <option>Empleo mixto</option>
                </select>
            </div>
            <div class="form-group">
                <label for="modalidad_entrevista">Modalidad de la entrevista</label>
                <select name="modalidad_entrevista" id="modalidad_entrevista" class="form-control" required/>
                <option selected disabled value="">Seleccionar ...</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="comentarios_vacante" name="comentarios_vacante" rows="3" placeholder="Ingresa un comentario de ser necesario, sino dejar vacío" required></textarea>
            </div>
            <br>
            <br>
            <div class="container-fluid text-center">
              ...
              <button type="submit" name="add" class="btn btn-success">Añadir</button>
            </div>
          </form>
        </div>
      </div>
