<?php
	...
	if($_GET['id']){
		...
		$sql = "SELECT * FROM usuarios, entrevistas WHERE usuarios.id = entrevistas.id_postulante AND id_entrevista = {$id_entrevista}";
...
<html lang="es">
    <head>
        ...
        <title>Reagendar entrevista</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Reagendar entrevista</h1>
                        <hr>
                        <br>
                        <div class="container">
                        	<div class="row align-items-center justify-content-center">
    <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/reagendar_entrevista2.php" method="POST">
            <div class="form-group">
            	<label for="fecha_entrevista">Fecha de la entrevista</label>
            	<input type="date" id="fecha_entrevista" name="fecha_entrevista" class="form-control" value="<?php echo $data['fecha_entrevista']?>"/>
            </div>
            <div class="form-group">
            	<label for="hora_entrevista">Hora de la entrevista</label>
            	<input class="form-control" type="time" name="hora_entrevista" id="hora_entrevista" value="<?php echo $data['hora_entrevista']?>"/>
             </div>
            <?php 
            	if ($data['entrevista'] == 'Presencial'){ ?>
            		<input type="hidden" name="modalidad_entrevista" value="<?php echo $data['entrevista']?>"/>
                <div class="form-group">
                <label for="ubicacion_entrevista">Ubicación</label>
                <textarea class="form-control" id="ubicacion_entrevista" name="ubicacion_entrevista" rows="3" value="<?php echo $data['ubicacion_entrevista']?>"/><?php echo $data['ubicacion_entrevista']?></textarea>
            </div>
              ...
              <?php 
            		...
            		<input type="hidden" name="modalidad_entrevista" value="<?php echo $data['entrevista']?>"/>
            		<div class="form-group">
              <label for="link_teams">Link de teams</label>
              <input class="form-control" type="text" name="link_teams" id="link_teams" value="<?php echo $data['link_teams']?>"/>
            </div>
            ...
            <div class="container-fluid text-center">
              ...
              <button type="submit" name="add" class="btn btn-success">Reagendar</button>
            </div>
          </form>
        </div>
      </div>
