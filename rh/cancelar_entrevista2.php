<?php
	...
	if($_GET['id']){
		...
		$sql = "SELECT * FROM entrevistas WHERE id_entrevista = {$id_entrevista}";
...
<html lang="es">
    <head>
        ...
        <title>Cancelar entrevista</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Cancelar entrevista</h1>
                        <hr>
                        <br>
                        <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6">
        <div class="jumbotron px-5 py-5 shadow p-3 mb-5 bg-white rounded" style="background-color: #FFF">
          <h5 class="text-center">¿Realmente quieres cancelar la entrevista?</h5>
          <br>
          <br>
          <form action="php_action/cancelar_entrevista2.php" method="POST">
            ...
            <div class="container-fluid ">
                ...
                <label for="cancelacion_entrevista">Motivo</label>
                <textarea class="form-control" id="cancelacion_entrevista" name="cancelacion_entrevista" rows="4" placeholder="Ingresa el motivo de la cancelación" required/></textarea>
            </div>
            <br>
              <div class="form-group row">
                <div class="col-md-6">
                  <button type="submit" name="add" class="btn btn-success btn-lg btn-block">Sí cancelar</button>
                </div>
                <div class="col-md-6">
                  <a href="por_entrevistar_etapa2.php" class="btn btn-danger btn-lg btn-block" role="button">Cancelar</a>
                </div>
              </div>
            </div>
          </form>
