<?php
    ...
    if($_GET['id']){
        ...
        $sql = "SELECT * FROM entrevistas INNER JOIN usuarios ON entrevistas.id_postulante = usuarios.id INNER JOIN vacante ON vacante.id_vacante = usuarios.id_vacante WHERE id_entrevista = {$id_entrevista}";
...
<html lang="es">
    <head>
        ...
        <title>Entrevista realizada</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 text-center">Entrevista realizada (segunda etapa)</h1>
                        <hr>
                        <br>
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
    <div class="col-lg-6 shadow p-5 mb-2 bg-white rounded">
          <form action="php_action/estatus_entrevista_etapa2.php" method="POST">
            <div class="form-group">
              <label for="estatus_entrevista" class="disabledTextInput">Estatus de la entrevista</label>
              <input class="form-control" type="text" name="estatus_entrevista" id="estatus_entrevista" value="Realizada" disabled/>
              <input type="hidden" name="estatus_entrevista" value="Realizada"/>
            </div>
            <div class="form-group">
                <label for="estatus">Estatus del postulante</label>
            ...
            <div id="campo_oculto" class="form-group" style="display: none;">
                <label for="info_empleo">Información de la contratación</label>
                <textarea class="form-control" id="info_empleo" name="info_empleo" rows="3" placeholder="Ingresa la información de la contratación" ></textarea>
            </div>
            <br>
            <br>
            <input type="hidden" name="id" value="<?php echo $data['id_entrevista']?>"/>
            <input type="hidden" name="id_postulante" value="<?php echo $data['id_postulante']?>"/>
            <input type="hidden" name="puesto_vacante" value="<?php echo $data['puesto_vacante']?>"/>
            <input type="hidden" name="id_vacante" value="<?php echo $data['id_vacante']?>"/>
            <div class="container-fluid text-center">
              <a href="por_entrevistar_etapa2.php" class="btn btn-danger" role="button">Atrás</a>
