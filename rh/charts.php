            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Contrataciones</h1>
                        <hr>
                        <br>
                        <br>
                                <div class="card mb-4">
                                    <div class="card-header"><i class="fa-solid fa-briefcase"></i> Contrataciones</div>
...
$sql = "SELECT DATE_FORMAT(fecha_contratacion, '%M-%Y') as mes, COUNT(id) as total_contrataciones FROM contratacion GROUP BY DATE_FORMAT(fecha_contratacion, '%M-%Y') ORDER BY fecha_contratacion ASC";
...
if ($query->num_rows > 0) {
    ...
    echo "<center><p class='text-danger'>No existen contrataciones</center></p><br><br><br>";
}
...
var data = {
        ...
        "<?php echo strftime("%B de %Y", strtotime($d->mes));?>", 
        <?php endforeach; ?>
        ],
        datasets: [{
      ...
      pointBorderWidth: 2,
            data: [
        <?php foreach($data as $d):?>
        <?php echo $d->total_contrataciones;?>, 
        <?php endforeach; ?>
            ],     
        }]
    };
