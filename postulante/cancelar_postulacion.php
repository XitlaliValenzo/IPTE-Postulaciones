<?php
  ...
  if($_GET['id']){
    ...
    $sql = "SELECT * FROM usuarios WHERE estatus = 'Pendiente' and id = {$id}";
...
<head>
    ...
    <title>Cancelar postulación</title>
  <style>
   #nav {
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="jumbotron" style="background-color: #fff">
        <center><h2>Cancelar postulación</h2></center>
    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6">
        <div class="jumbotron px-5 py-5 shadow p-3 mb-5 bg-white rounded" style="background-color: #FFF">
          <br>
          <h5 class="text-center">¿Realmente quieres cancelar tu postulación?</h5>
          <br>
          <br>
          <form action="php_action/cancelar_postulacion.php" method="POST">
            <input type="hidden" name="id" value="<?php echo $data['id']?>"/>
            <div class="container-fluid text-center">
              <div class="form-group row">
                <div class="col-md-6">
                  <button type="submit" name="add" class="btn btn-success btn-lg btn-block">Sí</button>
                </div>
                <div class="col-md-6">
                  <a href="estatus.php" class="btn btn-danger btn-lg btn-block" role="button">Cancelar</a>
                </div>
              </div>
            </div>
          </form>
