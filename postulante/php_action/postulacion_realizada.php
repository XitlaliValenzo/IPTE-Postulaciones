...
<head>
	...
	<title>Postulación realizada</title>
  <style>
   #nav {
      ...
      <div class="card mb-3 shadow p-3 mb-5 bg-white rounded border-0" style="max-width: 540px; width: auto; margin: auto auto;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <div class="container-fluid text-center">
                <h3 class="card-title text-danger" style="color: #219EBC;">¡Postulación realizada exitosamente!</h3>
                <br>
                <a href="../home.php" class="btn btn-success" role="button">Regresar</a>
              </div>
            </div>
          </div>
        </div>
   ...
   <br>
    <footer class="page-footer font-small" style="background-color: #0E3E6B; ">
      <div class="footer-copyright text-center py-3 text-dark" style="font-size: 20px">
       ...
       <p style="color: white;">Información de contacto: <a style="color: white;" href="mailto: 21307002@utcgg.edu.mx">Administrador del sitio</a></p>
      </div>
    </footer>
