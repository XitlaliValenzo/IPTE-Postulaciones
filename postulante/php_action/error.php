      ...
      <div class="card mb-3 shadow p-3 mb-5 bg-white rounded border-0" style="max-width: 540px; width: auto; margin: auto auto;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <div class="container-fluid text-center">
                <h3 class="card-title text-danger" style="color: #219EBC;">¡Aún no has seleccionado ningún archivo!</h3>
                <br>
                <a href="../subir_archivos.php" class="btn btn-success" role="button">Regresar</a>
              </div>
            </div>
          </div>
        </div>
