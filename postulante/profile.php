...
<a href="eliminarcuenta.php?id=<?php echo $row['id'];?>" class="btn btn-danger"><i class="fa-solid fa-user-xmark"></i> Eliminar cuenta</a>
</div>
<br>
<br>
...
<h5 class="lead"><b><center><?php echo $row['nombre'] ?></center></b></h5>
    ...
    <br>
    <a href="editarperfil.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-block"><i class="fa-solid fa-pencil"></i> Editar perfil</a>
    <a href="cambiarpassword.php?id=<?php echo $row['id'];?>" class="btn btn-warning btn-block"><i class="fa-solid fa-lock"></i> Cambiar contraseña</a>
      </div>
    </div>
  </div>
</div>
